...
from lib.engine.onlineSimulationBO_kin import onlineSimulationWithNetwork as onlineSimulatorBO
...
if __name__ == '__main__':
    ...
    centerline_generator = CenterlineGenerator(intrinsic_matrix)
