...
from .keyBoardEvents import getAdditionBO
...
# simulates the movement of a bronchoscope through a 3D airway model
class onlineSimulationWithNetwork(object):
    ...
    def runManual(self, args):
        ...
        while 1:
            ...
            # se andar para a frente, apaga tudo para tras
            #if(direction[2]>0):
    ...
    #Code for running the bronco robot in "automatic mode"
